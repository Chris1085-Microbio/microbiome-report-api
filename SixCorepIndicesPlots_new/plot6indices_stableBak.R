...
setwd("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new")
OutFile<-("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SixCoreIndex.png")
OutFile1<-("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SixCoreIndexLegend.png")
showtext_auto()
font_add("ms", regular = "/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/msjh.ttc", bold = "/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/msjhbd.ttc")
img <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCICenterFigure.png")
CenterImg <- rasterGrob(img, interpolate=TRUE)
img1 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon1.png")
icon1 <- rasterGrob(img1, interpolate=TRUE)
img2 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon2.png")
icon2 <- rasterGrob(img2, interpolate=TRUE)
img3 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon3.png")
icon3 <- rasterGrob(img3, interpolate=TRUE)
img4 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon4.png")
icon4 <- rasterGrob(img4, interpolate=TRUE)
img5 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon5.png")
icon5 <- rasterGrob(img5, interpolate=TRUE)
img6 <- readPNG("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/SCI_icon6.png")
