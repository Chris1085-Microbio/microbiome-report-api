...
if (.Platform$OS.type == "unix") {
  # Linux / Mac
  message("Linux/Mac")
  setwd("/Users/chuanfang/chuanfang/02.Work/microbio/microbiome-report-api/SixCorepIndicesPlots_new_V2")
  SourcePath = "/Users/chuanfang/chuanfang/02.Work/microbio/microbiome-report-api/SixCorepIndicesPlots_new_V2"
} else {
  # Windows
  message("Windows")
  library(this.path)
