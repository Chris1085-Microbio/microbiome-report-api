...
trianglePng <- readPNG('/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/redTriangle.png')	
...
ggplot(data, aes(x, y)) + 
  ...
  ggsave("/opt/lampp/htdocs/microbiome-report-api/SixCorepIndicesPlots_new/8_test.png",width = 12, height = 8.5, dpi = 300)
