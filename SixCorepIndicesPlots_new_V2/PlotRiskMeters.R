...
if (.Platform$OS.type == "unix") {
  # Linux / Mac
  message("Linux/Mac")
  setwd("/opt/lampp/htdocs/microbiome-report-apiV2_260323/SixCorepIndicesPlots_new_V2")
  SourcePath = "/opt/lampp/htdocs/microbiome-report-apiV2_260323/SixCorepIndicesPlots_new_V2"
} else {
  # Windows
  message("Windows")
  library(this.path)
  ...
  SourcePath = "."
  args <- c(90, 60, 50, 30, 40, 70, 45, 100, 45, 0)
}
